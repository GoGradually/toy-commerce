...
public class JpaOrderRepository implements OrderRepository {
    ...
    @Override
    public List<Order> findOpenOrdersContainingProduct(Long productId) {
        return jpaRepository.findOpenOrdersContainingProduct(productId, OPEN_STATUSES).stream()
                .map(OrderJpaEntity::toDomain)
                .toList();
    }
    ...
    public boolean existsAnyOrderItemByProductId(Long productId) {
        return jpaRepository.existsAnyOrderItemByProductId(productId);
    }
}
