...
public class ToyCommerceExceptionErrorCodeMapper {
    ...
    private static final List<MappingRule> RULES = List.of(
            ...
            new MappingRule(ActiveProductDeletionException.class, ErrorCode.PRODUCT_DELETE_CONFLICT),
            new MappingRule(ProductStockRemainingException.class, ErrorCode.PRODUCT_DELETE_CONFLICT),
            new MappingRule(ProductReferencedByOrderException.class, ErrorCode.PRODUCT_DELETE_CONFLICT),
            ...
            new MappingRule(InvalidOrderReceiverNameException.class, ErrorCode.INVALID_REQUEST),
            new MappingRule(InvalidOrderReceiverPhoneException.class, ErrorCode.INVALID_REQUEST),
            new MappingRule(InvalidOrderZipCodeException.class, ErrorCode.INVALID_REQUEST),
            new MappingRule(InvalidOrderAddressException.class, ErrorCode.INVALID_REQUEST),
            new MappingRule(InvalidOrderCouponException.class, ErrorCode.INVALID_REQUEST),
            new MappingRule(InvalidOrderPaymentMethodException.class, ErrorCode.INVALID_REQUEST),
            ...
            new MappingRule(OrderProductNotFoundException.class, ErrorCode.PRODUCT_NOT_FOUND),
            new MappingRule(InactiveOrderProductException.class, ErrorCode.INACTIVE_CART_PRODUCT),
