...
class OrderProductStockEventHandlerTest {
    ...
    void shouldDecreaseStockInAscendingProductIdOrder() {
        OrderLineSnapshot firstItem = orderItem(20L, 1);
        OrderLineSnapshot secondItem = orderItem(11L, 2);
    ...
    private OrderLineSnapshot orderItem(Long productId, int quantity) {
        return new OrderLineSnapshot(productId, quantity);
    }
}
